...
import com.scanii.client.internal.Endpoints;
import com.scanii.client.internal.HttpHeaders;
...
import com.scanii.client.models.ScaniiResult;
...
import static com.scanii.client.ScaniiClients.VERSION;
...
public class DefaultScaniiClient implements ScaniiClient {
  ...
  public DefaultScaniiClient(ScaniiTarget target, String key, String secret, HttpClient httpClient) {
    ...
    this.userAgentHeader = HttpHeaders.UA + "/v" + VERSION;
